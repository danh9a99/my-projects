...
namespace DO_AN_WEBCF.Areas.Admin.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            Order order = db.Database.SqlQuery<Order>("Sp_DetailOrder @id",para).FirstOrDefault();
            if (order == null)
            {
                return HttpNotFound();
            }
        ...
        //            int res = a.create(order.CustomerID, order.ShipName, order.ShipMobile, order.ShipAddress, order.Status);
        //            if (res > 0)
        //            {
